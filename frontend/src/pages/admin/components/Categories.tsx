...
export const Categories = () => {
   ...
   return (
      <div className="w-9/12 mx-auto py-8 relative">
         <div className="flex justify-between items-center">
            <h3 className="mb-4 text-md">✏️ Editar categorías</h3>
         ...
         <div className="lg:grid lg:grid-cols-2">
            ...
            <section id="list-categories" className="lg:pl-2">
               {isLoading ? (
                  ...
                  <p className="text-violet-300">No hay categorías disponibles. Crea una primero.</p>
               ) : (
                  <div className="space-y-4">
                     {categories.map((category) => (
                        <div key={category.id} className="border-b-violet-200 border-b-2 p-4">
                           ...
                           <div className="transition-all duration-300 ease-in-out">
                              ...
                              <button onClick={() => startEditingCategory(category)} className="text-sm">
                                 ✏️ Editar
                              </button>
                           </div>
