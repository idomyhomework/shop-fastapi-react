...
10. **Testimonials** — _(only if user opted in)_ Horizontal drag-to-scroll testimonial cards
11. **Card Scanner** — _(only if user opted in)_ Three.js particle showcase
